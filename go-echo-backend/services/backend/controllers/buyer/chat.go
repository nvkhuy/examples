...
// @Description This API allows buyer to create chat message
// @Accept  json
// @Produce  json
...
// @Router /api/v1/buyer/chat/create_chat_message [post]
func BuyerCreateChatMessage(c echo.Context) error {
...
// @Description This API allows buyer to list message with pagination
// @Accept  json
// @Produce  json
...
// @Security ApiKeyAuth
// @Failure 404 {object} errs.Error
// @Router /api/v1/buyer/chat/get_message_list [get]
func BuyerGetChatMessageList(c echo.Context) error {
	var cc = c.(*models.CustomContext)
...
// @Description This API allows buyer to retrieve chat user relevant stage
// @Accept  json
// @Produce  json
// @Param inquiry_id query string false
// @Param purchase_order_id query string false
...
// @Security ApiKeyAuth
// @Failure 404 {object} errs.Error
// @Router /api/v1/buyer/chat/get_chat_relevant_stage [get]
func BuyerGetChatUserRelevantStage(c echo.Context) error {
	var cc = c.(*models.CustomContext)
